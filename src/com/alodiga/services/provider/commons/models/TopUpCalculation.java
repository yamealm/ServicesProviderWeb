...
@Table(name = "top_up_calculation")
public class TopUpCalculation extends AbstractSPEntity implements Serializable {
    ...
    public TopUpCalculation() {
    }

    public TopUpCalculation(Long id) {
        this.id = id;
    }
