...
public class CreditCardUtils {
     ...
     *      DINERS_CLUB      = 4;
     */
    public static Long getCardID(String number) {
        Long valid = null;
        ...
        if (isNumber(number)) {
             ...
             */ else if (digit2.equals("34") || digit2.equals("37")) {
                if (number.length() == 15) {
                    valid = CreditcardType.AMERICANEXPRESS;
                }
            } /* -----
             ...
             */ else if (digit2.equals("36") || digit2.equals("38")
                ...
                if (number.length() == 14) {
                    valid = CreditcardType.DINERSCLUB;
                }
            } else if ("60".equals(digit2)) {
                if (number.length() == 16) {
                    valid = CreditcardType.DISCOVER;
                }
            }
        }
        return valid;
    ...
    public static String hideCreditCardNumber(String number) {
        char ccToArray[] = number.toCharArray();
        String star = "*";
        String result = "";
    ...
    public static boolean validateCreditCardDate(Timestamp date) {
        Calendar cal = Calendar.getInstance();
        int currentMonth = cal.get(Calendar.MONTH);
        int currentYear = cal.get(Calendar.YEAR);
        System.out.println("date:"+date.toString());
        SimpleDateFormat format = new SimpleDateFormat("MM");
        int ccMonth = Integer.parseInt(format.format(date));
        System.out.println("ccMonth: "+ccMonth);
        format = new SimpleDateFormat("yyyy");
        int ccYear = Integer.parseInt(format.format(date));
        System.out.println("ccYear: "+ccYear);
        boolean valid = ((ccYear < currentYear) || ((currentYear == ccYear) && (ccMonth < currentMonth)));
    ...
    public static void main(String[] args) {
        ...
        System.out.println(" | "+validateCreditCardDate(time));
    }
}
